...
/**
 * [UWP Experimental Feature]
 *
 * \returns a pointer to the last window SDL knows about, used by mesa sdl bridge to create 1:1 framebuffer with window
 *
 */
extern DECLSPEC SDL_Window* SDLCALL SDL_GetLatestWindow();
